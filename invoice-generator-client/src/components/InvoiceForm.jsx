        ...
        <div className="invoiceform container py-4">
            <div className="mb-4">
                ...
                <div className="d-flex align-items-center gap-3">
                    <label htmlFor="image" className="form-label">
                        <img src={invoiceData.logo ? invoiceData.logo : assets.upload_area} alt="upload" width={48}/>
                    </label>
                        <input type="file" name="logo" id="image" hidden className="form-control" accept="image/*"
                        onChange={handleLogoUpload}></input>
                </div>
            </div>
            <div className="mb-4">
                <h5>Your Company</h5>
            ...
            <div className="mb-4"> 
                ...
                {invoiceData.items.map((item,index)=>(
                    <div key={index} className="class p-3 m-3">
            ...
            <div className="mb-4"> 
                <h5>Bank Account Details</h5>
                    <div className="row g-3">
                        <div className="col-md-4">
                            <input type="text" id="invoiceNumber" className="form-control" placeholder="Account Name"
                        ...
                        <div className="col-md-4">
                            ...
                            onChange={(e) => handleAccountChange('account', 'number', e.target.value)}/>
                        </div>
                        <div className="col-md-4">
                            <input type="text" className="form-control" placeholder="Branch/IFSC Code"
                            value={invoiceData.account.ifsccode}
                            onChange={(e) => handleAccountChange('account', 'ifsccode', e.target.value)} />
                        </div>
                    </div>      
            </div>
            <div className="mb-4">
